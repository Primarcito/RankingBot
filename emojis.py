...
DEFINITIONS = {
    ...
    "PENDING": EmojiDefinition("ranking_pendiente", "⏳", 1527991056640118854),
    "APPROVED": EmojiDefinition("ranking_aprobado", "✅", 1527991055020986378),
    "REJECTED": EmojiDefinition("ranking_rechazado", "❌", 1527991058250596403),
